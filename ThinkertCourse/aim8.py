...
root.title("Vishal Travels")
def setvals():
    print("Submitting form")
    print(f"the values {namevalue.get(), phonevalue.get(), gendervalue.get(), emergencyvalue.get(), billvalue.get(), payementmodevalue.get(), foodservicevalue.get()}")

    with open("records.txt","a") as f:
        f.write(f"the values {namevalue.get(), phonevalue.get(), gendervalue.get(), emergencyvalue.get(), billvalue.get(), payementmodevalue.get(), foodservicevalue.get()}\n")
